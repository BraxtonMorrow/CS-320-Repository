...
public class Contact {
	 ...
	 private static final String INITIALIZER_NUM = "19118675309";
	 ...
	 protected void updatePhoneNumber(String phoneNumber) {
		 ...
		 if (phoneNumber == null) {
			 ...
			 throw new IllegalArgumentException("Phone number length is invalid. Please make sure it is " + CONTACT_PHONENUM_LENGTH + " digits long.");
		 } 
		 else if (!phoneNumber.matches(regex)) {
			 throw new IllegalArgumentException("Phone numbers only contain numbers, try again");
		 } 
		 else {
